...
import net.springbootserver.kathanorbackend.exception.FileStorageException;
import net.springbootserver.kathanorbackend.exception.MyFileNotFoundException;
